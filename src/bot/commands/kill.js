...
new Command({
  ...
  arguments: [
    new Argument({
      name: "target",
      description: "who deserves to be killed",
      type: ArgumentType.USER,
      required: true
    })
  ],
  async run({ reply, arguments, member }) {
    let t = arguments.getMember('target')
    let target = t.user.username
    let author = member.user.username
    ...
    var kills = [
      ...
      `${author} turns on Goosebumps(2015 film) on the TV. ${target} being a scaredy-cat, dies of a heart attack.`,
      `${author} was so swagging that ${target} died due to it. #Swag`,
      ...
      `${target} died because they started playing with a fidget spinner but they realize it 2016 so you start fapping to the old witch in snow white and obama starts mowing their lawn and they jump out of the window and get ripped to pieces by Obama's lawn mower`,
      ...
      `${target} died while listening to 'It's everyday bro'`,
      ...
      `${target} dies from just being a bad, un-likable dude.`,
      ...
      `${target} dies on death row via a lethal injection after murdering ${author} and their family.`,
      ...
      `${target} trips over his own shoelaces and dies.`,
      ...
      `After the raid of roblox kids entered the server, ${target} died of cancer.`,
