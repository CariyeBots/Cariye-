...
module.exports = async (message, options) => {
    ...
    generalEmbed.fields[0].value = `Cards: ${yourcards.map(c => `[\`${c.emoji} ${c.rank}\`](https://i.imgur.com/1Ob4BIs.png)`).join(" ")}\nTotal:${isSoft ? " Soft" : ""} ${yourcards.map(c => c.value).reduce((a, b) => b+a)}`
    generalEmbed.fields[1].value = `Cards: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://i.imgur.com/1Ob4BIs.png) \` ? \`\nTotal: \` ? \``
    ...
    if (yourvalue === 21 && dealervalue != 21) {
        if (options.resultEmbed === true) {
            ...
            winEmbed.fields.push({ name: "Your hand", value: `Cards: [\`${yourcards[0].emoji} ${yourcards[0].rank}\`](https://i.imgur.com/1Ob4BIs.png) [\`${yourcards[1].emoji} ${yourcards[1].rank}\`](https://i.imgur.com/1Ob4BIs.png)\nTotal: ${yourvalue}` })
            winEmbed.fields.push({ name: "Dealer's hand", value: `Card: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://i.imgur.com/1Ob4BIs.png) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://i.imgur.com/1Ob4BIs.png)\nTotal: ${dealervalue}` })
    ...
    // }
        ...
        if (options.resultEmbed === true) {
            ...
            tieEmbed.fields.push({ name: "Your hand", value: `Cards: [\`${yourcards[0].emoji} ${yourcards[0].rank}\`](https://i.imgur.com/1Ob4BIs.png) [\`${yourcards[1].emoji} ${yourcards[1].rank}\`](https://i.imgur.com/1Ob4BIs.png)\nTotal: ${yourvalue}` })
            tieEmbed.fields.push({ name: "Dealer's hand", value: `Cards: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://i.imgur.com/1Ob4BIs.png) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://i.imgur.com/1Ob4BIs.png)\nTotal: ${dealervalue}` })
    ...
    const editReply = async (msg, reply, commandType) => {
        if (commandType === "message") {
            return await msg.editReply({ embeds: [reply], components: buttons ? [row1, row2] : [] })
        } else {
    ...
    if (options.resultEmbed === true) {
        ...
        finalEmbed.fields.push({ name: `Your hand`, value: `Cards: ${finalResult.ycard.map(c => `[\`${c.emoji} ${c.rank}\`](https://i.imgur.com/1Ob4BIs.png)`).join(" ")}\nTotal: ${finalResult.ycard.map(card => card.value).reduce((a, b) => b+a)}`, inline: true })
                if (finalResult.ycard2 != null) {
            finalEmbed.fields.push({ name: `Your 2nd hand`, value: `Cards: ${finalResult.ycard2.map(c => `[\`${c.emoji} ${c.rank}\`](https://i.imgur.com/1Ob4BIs.png)`).join(" ")}\nTotal: ${finalResult.ycard2.map(card => card.value).reduce((a, b) => b+a)}`, inline: true })
        }
        finalEmbed.fields.push({ name: `${message.client.user.username}'s hand`, value: `Cards: ${finalResult.dcard.map(c => `[\`${c.emoji} ${c.rank}\`](https://i.imgur.com/1Ob4BIs.png)`).join(" ")}\nTotal: ${finalResult.dcard.map(card => card.value).reduce((a, b) => b+a)}`, inline: true })
